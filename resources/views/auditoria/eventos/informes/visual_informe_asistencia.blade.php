	...
	@section('card-content')
		...
		<div id="">
            ...
            <div id="">
                ...
                @foreach($eventoById as $evento)
                <a href="{{route('informeasistencia.edit', $evento->IdEvento) }}" style="width: 150px; font-style: Roboto;" class="btn btn-primary btn-block editbutton pull-left"><span class="fa fa-download">    Descargar PDF</span></a>
                @endforeach()
            </div><!--end #content-->
            <!-- END CONTENT -->		
        </div>
