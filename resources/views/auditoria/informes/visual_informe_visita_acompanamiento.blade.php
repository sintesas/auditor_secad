...
@section('content')
	...
	@section('card-content')
		...
		<div id="">
            ...
            <a href="{{route('informevisitaacompanamiento.create') }}" style="width: 150px; font-style: Roboto;" class="btn btn-primary btn-block editbutton pull-left"><span class="fa fa-download"> Descargar PDF</span></a>
