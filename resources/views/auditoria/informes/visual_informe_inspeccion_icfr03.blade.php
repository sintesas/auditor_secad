...
@section('card-content')
                            ...
                            <div class="section-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-4 fecha">
                                        <table style="width:100%; height:10px" class="table table-bordered table-tipoReporte">
                                ...
                                <div class="row">
                                    ...
                                    <!-- Div responsable -->
                                    <div class="col-xs-12 filaFormulario">
                                        <div class="col-xs-4 gris firstColDivider"> RESPONSABLE DE LA UMA/ PROCESO/ DEPENDENCIA
                                            / ASPECTO INSPECCIONADO:</div>
                                        <div class="col-xs-8">
                                    ...
                                    <!-- Div Objetivo -->
                                    <div class="col-xs-12 filaFormulario">
                                        <div class="col-xs-4 gris firstColDivider"> OBJETIVO DE LA INSPECCION:<br><br><br><br>
                                        </div>
                                    ...
                                    <!-- Div Criterio -->
                                    <div class="col-xs-12 filaFormulario">
                                        <div class="col-xs-4 gris firstColDivider"> CRITERIO DE LA INSPECCION: <br><br></div>
                                    ...
                                    <div class="col-xs-12 filaFormulario">
                                        <div class="col-xs-4 gris firstColDivider firstColDivider-bottom"> NOMBRE INSPECTOR
                                            LÍDER / RESPONSABLE DE INSPECCIÓN / INSPECTOR: <br><br></div>
                                ...
                                <div class="row">
                                    <!-- Titulo -->
                                    <div class="col-xs-12 filaFormulario">
                                        <div class="col-xs-12 gris text-center firstColDivider"> ACTIVIDADES A DESARROLLAR <br>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 filaFormulario">
                                        <div class="col-xs-12 gris text-center"> ASPECTOS RELEVANTES <br>
                                            <p class="col-xs-12 gris text-center">(Se debe incluir todo aquello susceptible de
                                                ser resaltado por implicar utilidad, resultado, gestión, impacto y/o estrategia
                                                para el logro de los objetivos propuestos)</p>
                                        </div>
                                    </div>
                                    <!-- Primer cuadro de informacion -->
                                    <div class="col-xs-12 filaFormulario">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 filaFormulario">
                                        <div>
                                            <div class="col-md-2 gris firstColDivider firstColDivider-bottom text-center"> N°
                                            </div>
                                            <div class="col-md-3 gris firstColDivider firstColDivider-bottom text-center">
                                                CÓDIGO DE HALLAZGO </div>
                                            <div class="col-md-7 gris firstColDivider firstColDivider-bottom text-center">
                                        ...
                                        <div>
                                            ...
                                            @foreach($hallazgo as $itemHallazgo)
                                                @if($itemHallazgo->IdTipoAnotacion == 1 && $itemHallazgo->IdEnUnaAnotacion == 1)
                                                    <div class="col-md-2  negro firstColDivider firstColDivider-bottom">
                                                        {{ $cont }} </div>
                                                    <div class="col-md-3  negro firstColDivider firstColDivider-bottom">
                                                        {{ $itemHallazgo->NoAnota }} </div>
                                                    <div class="col-md-7  negro firstColDivider firstColDivider-bottom">
								...
								<div class="row">
									<p style="font-size:12px"> <strong style="font-size: 15px"> NO CONFORMIDAD REPETITIVA </strong>(Anteriormente
										evidenciado, con plan de mejoramiento cerrado. Por lo tanto, se debe elaborar plan de mejoramiento)</p>
									<div class="col-xs-12 filaFormulario">
										<div>
									...
									<div class="col-xs-12 filaFormulario">
										<div>
											...
											<div class="col-xs-3 gris firstColDivider firstColDivider-bottom text-center header-table"
												...
												anteriormente la No Conformidad <br><br></div>
    ...
    <a href="{{ route('informeinspeccionicfr03.edit', $id_auditoria) }}" style="width: 150px; font-style: Roboto;"
        class="btn btn-primary btn-block editbutton pull-left"><span class="fa fa-download"> Descargar PDF</span></a>
    </div>
    </div>
