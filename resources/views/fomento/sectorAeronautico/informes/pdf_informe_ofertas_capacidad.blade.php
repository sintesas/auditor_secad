                            ...
                            <div class="col-xs-12 filaFormulario table-fixed">
                                <table class="table  table-x">
                                  <tr>
                                    ...
                                    <tr class="line-b">  
                                        <th class="text-center">{{$ofertaCapacidadR->NombreEmpresa}}</th>                             
                                        <th class="text-center">{{$ofertaCapacidadR->Email}}</th>
                                        <th class="text-center">{{$ofertaCapacidadR->Nit}}</th>                             
                                        <th class="text-center">{{$ofertaCapacidadR->PaginaWeb}}</th>
                                        <th class="text-center">{{$ofertaCapacidadR->Telefono}}</th>                             
                                        <th class="text-center">{{$ofertaCapacidadR->Direccion}}</th>
                                        <th class="text-center">{{$ofertaCapacidadR->RazonSocial}}</th>                                                                    
                                  </tr>                                  
                                    @endforeach
                                    @else
                                      <div class="section-body">
