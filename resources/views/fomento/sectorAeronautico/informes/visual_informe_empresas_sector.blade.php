                    ...
                    <div class="section-body">
                       <div class="row encabezadoPlanInspeccion">
                            ...
                            <div class="col-xs-12 text-center azul8080">
                                <h4> OFICINA CERTIFICACIÓN AERONAUTICA DE LA DEFENSA</h4>
                            </div>
                        ...
                        <div class="col-xs-12">
                            ...
                            <a href="{{route('informeempresasxsector.edit', $sectoraeronautico->IdOfertaComercial ) }}" style="width: 150px; font-style: Roboto;" class="btn btn-primary btn-block editbutton pull-left"><span class="fa fa-download">    Descargar PDF</span></a>
