...
@section('title')
	Informe Personal por Especialidad
@endsection()
...
@section('content')
	...
	@section('card-content')
		...
		@section('card-title')
            ...
            {{ Breadcrumbs::render('ver_informepersonalespecialidad') }}
		@endsection()
		...
		<div id="">
                       ...
                       <div class="row encabezadoPlanInspeccion">
                        ...
                        <div class="row">                            
                            <div class="col-xs-12 text-center gris57">
                                <h4> Informe Personal por Especialidad</h4>
                            </div>                            
                            <!-- FIN Div-->                       
                            <!-- Responsable Proceso -->
            ...
            <a href="{{route('informepersonalespecialidad.create') }}" style="width: 150px; font-style: Roboto;" class="btn btn-primary btn-block editbutton pull-right"><span class="fa fa-download"> Descargar PDF</span></a>
