...
@section('content')
	...
	@section('card-content')
		...
		@section('card-title')
            ...
            {{ Breadcrumbs::render('ver_informepersonalareasecad') }}
		@endsection()
		...
		<div id="">
                       ...
                       <div class="row encabezadoPlanInspeccion">
                        ...
                        <div class="row">                            
                            <div class="col-xs-12 text-center gris57">
                                <h4> Informe Personal por Area SECAD</h4>
                            </div>                            
                            <!-- FIN Div-->                       
                            <!-- Responsable Proceso -->
            ...
            <a href="{{route('informepersonalareasecad.edit', $persona->IdCargo) }}" style="width: 150px; font-style: Roboto;" class="btn btn-primary btn-block editbutton pull-right"><span class="fa fa-download">    Descargar PDF</span></a>
            @endforeach()
