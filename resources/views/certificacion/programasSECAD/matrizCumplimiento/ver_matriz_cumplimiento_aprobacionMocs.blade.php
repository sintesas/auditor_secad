...
MOCs - Aprobación  - Matriz

@endsection()

@section('card-content')
<h4><strong>Codigo Requisito:</strong> {{$req->CodigoRequisito}}</h4>
<h4><strong>Nombre Requisito:</strong> {{$req->NombreRequisito}}</h4>
<div class="col-lg-12">
		...
		<table id="datatable1" class="table table-striped table-hover">
			...
			<tbody>
				...
				<tr class="moc{{$moc->IdMOC}}">
					...
					<td>
						<div class="col-sm-6">							
							<a href="{{route('aprobacionMocsSupartes.edit', $moc->IdMocRequisito) }}" class="btn btn-primary btn-block editbutton" ><div class="gui-icon"><i class="fa fa-pencil"></i></div></a>
