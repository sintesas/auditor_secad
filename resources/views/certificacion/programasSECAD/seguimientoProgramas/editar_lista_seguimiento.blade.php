...
@section('content')
	...
	@section('card-content')
		...
		@section('form-tag')
        {!! Form::model($seguimiento, [
    'route' => ['seguimiento.update', $seguimiento->IdListaSeguimiento],
    'method' => 'PUT',
    'files' => true, 
]) !!}
		...
		@section('card-title')
        {{Breadcrumbs::render('editarseguimiento',$programa->IdPrograma, $actividad->IdActividad.'&'.$programa->IdPrograma)}} 
		@endsection()
                 ...
                 <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="demo-date-format">
                                        <div class="input-group-content">
                                            <input type="text" class="form-control" id="Fecha" name="Fecha"value="{{$seguimiento->Fecha}}"  required>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="Porcentaje" name="Porcentaje" value="{{$lastSeguimiento->Porcentaje}}" required onchange="validarPorcentaje()">
