...
<head>
    ...
    <title>Informe General Auditoria Programas</title>
    <style>
        @page {
		    margin: 0cm 0cm;
            ...
            <tbody>
                <tr>
                    ...
                    <td style="width: 55%;">
                        ...
                        <div class="d2" style="padding: 7px 0px">FORMATO REPORTE GENERAL DE AUDITORÍA</div>
                    </td>
                    <td>
                        <div class="col-td-4">
                        ...
                        <div class="col-td-8">
                            <div class="d3 border-b" style="padding: 2px">GA-JELOG-FR-437</div>
...
<table class="table5">
    <thead>
        <tr>
            <th colspan="12" class="th1">7. AGENDA DE LA AUDITORÍA</th>
        </tr>
    </thead>
    <tbody>
        <tr>
            <td class="center" style="background: #c0c0c0; font-size: 11px; padding: 5px !important;"><strong>7.1. Fecha de Apertura</strong></td>
            <td class="center" style="font-size: 11px; padding: 6px !important;">{{ $planAuditoria->fecha_reunion_apertura }}</td>
            <td colspan="5" class="center" style="background: #c0c0c0; font-size: 11px; padding: 5px !important;"><strong>7.2. Fecha de Cierre</strong></td>           
            <td colspan="5" class="center" style="font-size: 9px; padding: 5px !important;">{{ $planAuditoria->fecha_reunion_cierre }}</td>
        </tr>
    </tbody>
</table>
...
<thead>
    <tr>
        <th class="th2" style="text-align:center;width: 5%;height:25px;">No.</th>
        <th class="th2" style="text-align:center;width: 35%;">7.3. Proceso / Aspectos a Auditar / Actividad</th>
        <th class="th2" style="text-align:center;width: 10%;">7.4. Fecha</th>
        <th class="th2" style="text-align:center;width: 10%;">7.5. Hora de Inicio</th>
        <th class="th2" style="text-align:center;width: 10%;">7.6. Hora Finalización</th>
        <th class="th2" style="text-align:center;width: 15%;">7.7. Responsable</th>
        <th class="th2" style="text-align:center;width: 15%;">7.8. Auditado</th>
    </tr>
</thead>
</table>
<table class="table5">
                        ...
                        <tr>
        <td class="td3 center" style="width: 5%;height:25px;">{{ $contador }}</td>
        <td class="td3" style="text-align:justify; padding: 10px;width: 35%;">{{$agenda->proceso}}</td>
        <td class="td3 center" style="width: 10%;">{{$agenda->Fecha}}</td>
        <td class="td3 center" style="width: 10%;">{{ \Carbon\Carbon::parse($agenda->hora_inicio)->format('H:i') }}</td>
        <td class="td3 center" style="width: 10%;">{{ \Carbon\Carbon::parse($agenda->hora_fin)->format('H:i') }}</td>
        <td class="td3 center" style="width: 15%;">{{$agenda->responsable}}</td>
        <td class="td3 center" style="width: 15%;">{{$agenda->auditado}}</td>
        </tr>
        @php $contador++; @endphp
        @endforeach
    ...
    <thead>
        <tr>
            <th colspan="7" class="th1 center">8. DESARROLLO DE LA AUDITORÍA</th>
        </tr>
    </thead>
    <tbody>
        <tr>
...
<table class="table5">
    <thead>
        <tr>
            <th colspan="12" class="th1">9. HALLAZGOS</th>
        </tr>
    </thead>
    <tbody>
        <tr>
            <td colspan="1" class="th2" style="background: #c0c0c0; font-size: 11px;text-align:center;height:25px;"><strong>No.</strong></td>
            <td colspan="2" class="center" style="background: #c0c0c0; font-size: 11px; padding: 5px !important;"><strong>9.1. Tipo de Hallazgo</strong></td>
            <td colspan="9" class="center" style="background: #c0c0c0; font-size: 11px; padding: 5px !important;width: 490px"><strong>9.2. Descripción del Hallazgo</strong></td>
        </tr>
        @php $contador = 1; @endphp
...
<table class="table5">
    <tbody>
        <tr>
            <td  class="center" style="background: #c0c0c0; font-size: 11px; padding: 5px !important;width:45%; border-top:0px;"><strong>9.3. Total Conformidades</strong></td>
            <td  class="center" style="font-size: 11px; padding: 5px !important;width:5%;border-top:0px;">{{ $informe->total_conformidades }}</td>
            <td  class="center" style="background: #c0c0c0; font-size: 11px; padding: 5px !important;width:45%;border-top:0px;"><strong>9.4. Total Oportunidad de Mejora</strong></td>           
...
<table class="table5">
    <tbody>
        <tr>
            <td class="center" style="background: #c0c0c0; font-size: 11px; padding: 5px !important;width:45%; border-top:0px"><strong>9.5 Total No Conformidades Menor</strong></td>
            ...
            <td  class="center" style="background: #c0c0c0; font-size: 11px; padding: 5px !important;width:45%; border-top:0px"><strong>9.6. Total No Conformidades Mayor</strong></td>           
...
<table class="table5">
    <thead>
        <tr>
            <th colspan="7" class="th1 center">10. CONCLUSIONES DEL INFORME</th>
        </tr>
    </thead>
    <tbody>
        <tr>
...
<table class="table5">
    <thead>
        <tr>
            <th colspan="19" class="th1">11. PLAN ACCIÓN DE MEJORAMIENTO</th>
        </tr>
    </thead>
    </table>
    <table class="table5">
    <tbody>
        @php $contador = 1; @endphp
        @foreach ($planaccionhallazgos as $planaccionh)
            <tr>
                <td class="center" style="background: #c0c0c0; font-size: 11px; padding: 5px;border-top: none;"><strong>No.</strong></td>
                <td class="center" style="font-size: 11px; padding: 5px;border-top: none;">{{ $contador }}</td>
                <td class="center" style="background: #c0c0c0; font-size: 11px; padding: 5px;border-top: none;"><strong>Tipo Hallazgo</strong></td>
                <td class="center" colspan="4" style="font-size: 11px; padding: 5px;border-top: none;">{{ $planaccionh->TipoHallazgo }}</td>
                <td class="center" style="background: #c0c0c0; font-size: 11px; padding: 5px;border-top: none;"><strong>Fecha Inicio</strong></td>
                <td class="center" style="font-size: 11px; padding: 5px;border-top: none;">{{ $planaccionh->fecha_inicio }}</td>
                <td class="center" style="background: #c0c0c0; font-size: 11px; padding: 5px;border-top: none;"><strong>Fecha Final</strong></td>
                <td class="center" colspan="2" style="font-size: 11px; padding: 5px;border-top: none;">{{ $planaccionh->fecha_fin }}</td>
            </tr>

            <tr>
                <td class="center" colspan="12" style="background: #c0c0c0; font-size: 11px; padding: 5px;"><strong>Descripción del Hallazgo</strong></td>
            </tr>
            <tr>
                <td colspan="12" style="font-size: 11px; padding: 5px; text-align: justify;">{{ $planaccionh->descripcion_hallazgos }}</td>
            </tr>

            <tr>
                <td class="center" colspan="12" style="background: #c0c0c0; font-size: 11px; padding: 5px;"><strong>Análisis Causa Raíz</strong></td>
            </tr>
            <tr>
                <td colspan="12" style="font-size: 11px; padding: 5px; text-align: justify;">{{ $planaccionh->causa_raiz }}</td>
            </tr>

            <tr>
                <td class="center" colspan="12" style="background: #c0c0c0; font-size: 11px; padding: 5px;"><strong>Acciones de Mejora</strong></td>
            </tr>
            <tr>
                <td colspan="12" style="font-size: 11px; padding: 5px; text-align: justify;">{{ $planaccionh->acciones_mejora }}</td>
            </tr>

            <tr>
                <td class="center" colspan="12" style="background: #c0c0c0; font-size: 11px; padding: 5px;"><strong>Evaluación</strong></td>
            </tr>
            <tr>
                <td colspan="12" style="font-size: 11px; padding: 5px; text-align: justify;">{{ $planaccionh->evaluacion }}</td>
            </tr>
    ...
    <thead>
        <tr>
            <th colspan="7" class="th1 center">Observaciones</th>
        </tr>
    </thead>
    <tbody>
        <tr>
        <td colspan="7" class="td1-2" style="word-wrap: break-word; overflow-wrap: break-word; word-break: break-word; white-space: normal; page-break-inside: auto;text-align: justify;">
                {{ $planaccion->observaciones }}
            </td>
...
<table class="table5">
    <thead>
        <tr>
            <th colspan="12" class="th1">12. SEGUIMIENTO PLAN ACCIÓN DE MEJORAMIENTO</th>
        </tr>
    </thead>
</table>
...
<table class="table5">
    <tbody>
        @php $contador = 1; @endphp
        @foreach ($seguimientoplanaccionhallazgos as $seguimientohallazgos)
            <tr>
                <td class="center" style="background: #c0c0c0; font-size: 11px; padding: 5px;border-top:none;"><strong>No.</strong></td>
                <td class="center" style="font-size: 11px; padding: 5px;border-top:none;">{{ $contador }}</td>
                <td class="center" style="background: #c0c0c0; font-size: 11px; padding: 5px;border-top:none;"><strong>Tipo Hallazgo</strong></td>
                <td class="center" colspan="9" style="font-size: 11px; padding: 5px;border-top:none;">{{ $seguimientohallazgos->TipoHallazgo }}</td>
            </tr>
            ...
            <tr>
                <td colspan="12" style="font-size: 11px; padding: 5px; text-align: justify;">
                    {{ $seguimientohallazgos->descripcion_hallazgos }}
                </td>
            </tr>
            ...
            <tr>
                <td colspan="12" style="font-size: 11px; padding: 5px; text-align: justify;">
                    {{ $seguimientohallazgos->acciones_mejora }}
                </td>
            </tr>

            <tr>
                <td class="center" colspan="12" style="background: #c0c0c0; font-size: 11px; padding: 5px;"><strong>Seguimiento / Evidencia</strong></td>
            </tr>
            <tr>
                <td colspan="12" style="font-size: 11px; padding: 5px; text-align: justify;">
                    {{ $seguimientohallazgos->seguimiento }}
                </td>
            </tr>
    ...
    <thead>
        <tr>
            <th colspan="7" class="th1 center">13. CONCLUSIONES DE SEGUIMIENTO</th>
        </tr>
    </thead>
    <tbody>
        <tr>
        <td colspan="7" class="td1-2" style="word-wrap: break-word; overflow-wrap: break-word; word-break: break-word; white-space: normal; page-break-inside: auto;text-align: justify;">
                {{ $seguimientoplanaccion->conclusiones }}
            </td>
...
<table class="table5">
                   <thead>
        <tr>
            <th colspan="9" class="th1">14. FIRMAS</th>
        </tr>
    </thead>
    </table>
                    <table class="table5">
