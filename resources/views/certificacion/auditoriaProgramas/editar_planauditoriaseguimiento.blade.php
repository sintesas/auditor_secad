...
{!! Form::model($seguimiento, ['route' => ['planauditoriaseguimiento.update', $seguimiento->id_planauditoriaseguimiento], 'method' => 'PUT', 'files' =>true ]) !!}
...
<div style="display: flex; align-items: center;">
        <span>
        {{ Breadcrumbs::render('editarplanauditoriaseguimiento', $id_auditoriaprog) }}	
        </span>
...
<div class="card-body floating-label">
                ...
                <div class="form-group control-width-normal">
                    <div class="input-group date" id="demo-date-format">
                        <div class="input-group-content">
                            {{ Form::text('fecha_seguimiento', $seguimiento->fecha_seguimiento, array('class' => 'form-control', 'required' => '' )) }}
    ...
    <tr>
        ...
        <td style="vertical-align: middle;">
            <textarea type="text" name="seguimiento[]" class="form-control" style="height:41px;border: none; border-bottom: 2px solid #48548c;resize: vertical; overflow-y: auto;" required>{{ $hallazgos->seguimiento }}</textarea>
        </td>
        ...
        <td style="vertical-align: middle; text-align: center;">
            ...
            <div id="nombreArchivo{{ $index }}" 
                 style="margin-top: 5px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 170px; text-align: center; display: inline-block;" 
...
@foreach($planinformehallazgos as $index => $informeh)
    {{-- Verifica si el tipo_hallazgo y descripcion no están en seguimientoHallazgos --}}
    @php
        $existsInSeguimiento = false;
        foreach ($seguimientoHallazgos as $hallazgo) {
            if ($hallazgo->TipoHallazgo == $informeh->TipoHallazgo && $hallazgo->descripcion_hallazgos == $informeh->descripcion_hallazgos) {
                $existsInSeguimiento = true;
                break;
            }
        }
    @endphp

    {{-- Si no existe en seguimientoHallazgos, lo mostramos --}}
    @if(!$existsInSeguimiento)
        <tr>
        ...
        <div class="row" style="margin-top:50px;">
             <div class="col-sm-12">
                <div class="form-group">
                    <textarea class="form-control" id="conclusiones" name="conclusiones" rows="2" maxlength="1000" style="resize: vertical; overflow-y: auto;" required> {{ $seguimiento->conclusiones}} </textarea>
