...
<head>
    ...
    <title>Informe Seguimiento Plan Acción Hallazgos</title>
    <style>
        @page {
		    margin: 0cm 0cm;
            ...
            <tbody>
                <tr>
                    ...
                    <td style="width: 55%;">
                        ...
                        <div class="d2" style="padding: 7px 0px">FORMATO SEGUIMIENTO PLAN ACCIÓN HALLAZGOS AUDITORÍA</div>
                    </td>
                    <td>
                        <div class="col-td-4">
                        ...
                        <div class="col-td-8">
                            <div class="d3 border-b" style="padding: 2px">GA-JELOG-FR-401</div>
...
<table style="width: 100%; border-collapse: collapse; border: 1px solid black; border-bottom: 0px; margin-top: -1px;">
    <thead>
        ...
        SEGUIMIENTO PLAN ACCIÓN HALLAZGOS AUDITORÍA
            </th>
            <th style="width: 30%; text-align: center; font-weight: bold; border: 1px solid black; border-bottom: 0px; font-size: 10px; padding: 0;">
                <div style="background-color: #d3d3d3; padding: 5px 0; width: 99.8%; display: block;border-bottom:1px solid black">
                    1.1. Fecha Seguimiento Plan Acción
                </div>
                <div style="font-weight: normal; font-size: 12px; padding: 5px 0;">
                {{$seguimientoplanaccion->fecha_seguimiento}}
                </div>
            </th>
        </tr>
    </thead>
...
<table class="table5">
    <thead>
        <tr>
            <th colspan="12" class="th1">4. SEGUIMIENTO PLAN ACCIÓN DE MEJORAMIENTO</th>
        </tr>
    </thead>
</table>
...
<table class="table5">
    ...
    <thead>
        <tr>
            <th colspan="7" class="th1 center">5. CONCLUSIONES DE SEGUIMIENTO</th>
        </tr>
    </thead>
    <tbody>
        <tr>
...
<table class="table5">
                   <thead>
        <tr>
            <th colspan="9" class="th1">6. FIRMAS</th>
        </tr>
    </thead>
    </table>
                    <table class="table5">
