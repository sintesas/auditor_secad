...
<head>
    ...
    <title>Informe Plan Auditoria Programas</title>
    <style>
        @page {
		    margin: 0cm 0cm;
            ...
            <tbody>
                <tr>
                    ...
                    <td style="width: 55%;">
                        ...
                        <div class="d2" style="padding: 7px 0px">FORMATO PLAN AUDITORÍA</div>
                    </td>
                    <td>
                        <div class="col-td-4">
                        ...
                        <div class="col-td-8">
                            <div class="d3 border-b" style="padding: 2px">GA-JELOG-FR-404</div>
...
<table style="width: 100%; border-collapse: collapse; border: 1px solid black; border-bottom: 0px; margin-top: -1px;">
    <thead>
        <tr>
            <th style="width: 70%; background-color: #d3d3d3; text-align: center; font-weight: bold; font-size: 14px; vertical-align: middle;" colspan="3">
                PLAN AUDITORÍA
            </th>
...
<div class="footer">
    ...
    <thead>
            <tr>
                <th colspan="12" class="th1" style="border-top: none !important;">3. DATOS GENERALES DE LA AUDITORÍA</th>
            </tr>
        </thead>          <tr>
...
<table class="table5">
    ...
    <tbody>
        <tr>
            <th class="th2" style="text-align:center;width: 10%;height:25px;width:20px"> No.</th>
            <td class="center" style="background: #c0c0c0; font-size: 11px; padding: 5px !important;"><strong>6.1. Nombres y Apellidos Integrantes Equipo Auditor</strong></td>
            <td colspan="5" class="center" style="background: #c0c0c0; font-size: 11px; padding: 5px !important;"><strong>6.2. Rol</strong></td>
        </tr>
        
        @php $contador = 1; @endphp
        @foreach ($equipoAuditor as $equipoA) 
        <tr>
             <td class="td3 center">{{ $contador }}</td>
            <td class="center" style="font-size: 11px; padding: 5px !important;">{{ $equipoA->integrante }}</td>
            <td colspan="5" class="center" style="font-size: 9px; padding: 5px !important;">{{ $equipoA->Rol }}</td>
        </tr>
        @php $contador++; @endphp
        @endforeach
    </tbody>
...
<table class="table5">
        ...
        @endforeach
                   ...
                   <thead>
        <tr>
            <th colspan="9" class="th1">8. FIRMAS</th>
        </tr>
    </thead>
    </table>
                    <table class="table5">
