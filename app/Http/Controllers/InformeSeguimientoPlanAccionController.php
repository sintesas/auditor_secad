...
class InformeSeguimientoPlanAccionController extends Controller
{
    /**
    ...
    public function informe_preview($id_planauditoria) {
        ...
        $seguimientoplanaccion = \DB::table('AU_Reg_AuditoriaProgramasPlanAuditoriaSeguimiento')
        ->where('id_planauditoria', $id_planauditoria)
        ->first();

        $id_planauditoriaseguimiento = $seguimientoplanaccion->id_planauditoriaseguimiento;


        $seguimientoplanaccionhallazgos = \DB::table('VWAU_Reg_AuditoriaProgramasPlanAuditoriaSeguimientoHallazgo')
        ->where('id_planauditoriaseguimiento', $id_planauditoriaseguimiento)
        ->get();
        
        $html = view('certificacion.auditoriaProgramas.pdf_visual_seguimientoplanaccion_auditoriaprograma',
                    compact(
                        'auditoriaProgramas',
                        'Empresa',
                    'planAuditoria',
                    'criterios',
                'equipoAuditor','agenda', 'informe', 'hallazgosInforme', 'planaccion', 'planaccionhallazgos', 'seguimientoplanaccion', 'seguimientoplanaccionhallazgos'))
                ->render();
    ...
    public function informe($id_planauditoria) {
        ...
        return $pdf->download('informe_seguimiento'.'.pdf');;
    }
