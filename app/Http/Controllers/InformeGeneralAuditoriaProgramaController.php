...
class InformeGeneralAuditoriaProgramaController extends Controller
{
    /**
    ...
    public function informe_preview($id_planauditoria) {
        ...
        $html = view('certificacion.auditoriaProgramas.pdf_visual_informegeneral_auditoriaprograma',
                    compact(
                        'auditoriaProgramas',
                        'Empresa',
                    'planAuditoria',
    ...
    public function informe($id_planauditoria) {
        ...
        return $pdf->download('informe_general'.'.pdf');;
    }
