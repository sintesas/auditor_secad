...
class InformePlanAuditoriaInformeProgramaController extends Controller
{
    /**
    ...
    public function informe_preview($id_planauditoria) {
        ...
        $html = view('certificacion.auditoriaProgramas.pdf_visual_informeplan_auditoriainformeprograma',
                    compact(
                        'auditoriaProgramas',
                        'Empresa',
                    'planAuditoria',
                    'criterios',
                'equipoAuditor', 'informe', 'hallazgosInforme'))
                ->render();
    ...
    public function informe($id_planauditoria) {
        ...
        return $pdf->download('informe_auditoría'.'.pdf');;
    }
