...
(c) Dinamenta, UAB.
*/
function dtmlXMLLoaderObject(e, t, i, a) { return this.xmlDoc = "", "undefined" != typeof i ? this.async = i : this.async = !0, this.onloadAction = e || null, this.mainObject = t || null, this.waitCall = null, this.rSeed = a || !1, this }
...
function getOffsetRect(e) { var t = e.getBoundingClientRect(),
        ...
        l = t.top + r - n,
        o = t.left + s - d; return { top: Math.round(l), left: Math.round(o) } }
...
window.dhtmlXScheduler = window.scheduler = { version: "4.4.0" }, window.dhtmlx || (dhtmlx = function(e) { for (var t in e) dhtmlx[t] = e[t]; return dhtmlx }), dhtmlx.extend_api = function(e, t, i) {
    ...
    dtmlXMLLoaderObject.prototype.waitLoadFunction = function(e) { var t = !0; return this.check = function() { if (e && e.onloadAction && (!e.xmlDoc.readyState || 4 == e.xmlDoc.readyState)) { if (!t) return;
        ...
        if (_isIE) this.xmlDoc = new ActiveXObject("Microsoft.XMLDOM"), this.xmlDoc.async = this.async, this.xmlDoc.onreadystatechange = function() {}, this.xmlDoc.loadXML(e);
            ...
            this.xmlDoc = i.parseFromString(e, "text/xml") } t || (this.onloadAction && this.onloadAction(this.mainObject, null, null, null, this), this.waitCall && (this.waitCall(), this.waitCall = null))
        ...
        t._tagvalue = e.firstChild ? e.firstChild.nodeValue : ""; for (var i = 0; i < e.childNodes.length; i++) { var a = e.childNodes[i].tagName;
            a && (t[a] || (t[a] = []), t[a].push(this.xmlNodeToJSON(e.childNodes[i]))) } return t }, dhtmlDragAndDropObject.prototype.removeDraggableItem = function(e) {
        ...
        if (window.name) { for (var t = parent.frames[window.name].frameElement.offsetParent, i = 0, a = 0; t;) i += t.offsetLeft, a += t.offsetTop, t = t.offsetParent; if (parent.dhtmlDragAndDrop) { var r = parent.dhtmlDragAndDrop.calculateFramePosition(1);
                i += 1 * r.split("_")[0], a += 1 * r.split("_")[1] } if (e) return i + "_" + a;
            this.fx = i, this.fy = a }
        return "0_0"
    ...
    _isChrome = !1, _FFrv = !1, _KHTMLrv = !1, _OperaRv = !1, -1 != navigator.userAgent.indexOf("Macintosh") && (_isMacOS = !0), navigator.userAgent.toLowerCase().indexOf("chrome") > -1 && (_isChrome = !0), -1 != navigator.userAgent.indexOf("Safari") || -1 != navigator.userAgent.indexOf("Konqueror") ? (_KHTMLrv = parseFloat(navigator.userAgent.substr(navigator.userAgent.indexOf("Safari") + 7, 5)), _KHTMLrv > 525 ? (_isFF = !0, _FFrv = 1.9) : _isKHTML = !0) : -1 != navigator.userAgent.indexOf("Opera") ? (_isOpera = !0, _OperaRv = parseFloat(navigator.userAgent.substr(navigator.userAgent.indexOf("Opera") + 6, 3))) : -1 != navigator.appName.indexOf("Microsoft") ? (_isIE = !0, -1 == navigator.appVersion.indexOf("MSIE 8.0") && -1 == navigator.appVersion.indexOf("MSIE 9.0") && -1 == navigator.appVersion.indexOf("MSIE 10.0") || "BackCompat" == document.compatMode || (_isIE = 8)) : "Netscape" == navigator.appName && -1 != navigator.userAgent.indexOf("Trident") ? _isIE = 8 : (_isFF = !0, _FFrv = parseFloat(navigator.userAgent.split("rv:")[1])), dtmlXMLLoaderObject.prototype.doXPath = function(e, t, i, a) {
        ...
        var n = [],
            d = t.evaluate(e, r, function(e) { return i }, s, null);
    ...
    dtmlXMLLoaderObject.prototype.doXPathOpera = function(e, t) { var i = e.replace(/[\/]+/gi, "/").split("/"),
            a = null,
            r = 1; if (!i.length) return []; if ("." == i[0]) a = [t];
        else { if ("" !== i[0]) return [];
            a = (this.xmlDoc.responseXML || this.xmlDoc).getElementsByTagName(i[r].replace(/\[[^\]]*\]/g, "")), r++ } for (r; r < i.length; r++) a = this._getAllNamedChilds(a, i[r]); return -1 != i[r - 1].indexOf("[") && (a = this._filterXPath(a, i[r - 1])), a }, dtmlXMLLoaderObject.prototype._filterXPath = function(e, t) {
        ...
        _isKHTML && (t = t.toUpperCase()); for (var a = 0; a < e.length; a++)
            for (var r = 0; r < e[a].childNodes.length; r++) _isKHTML ? e[a].childNodes[r].tagName && e[a].childNodes[r].tagName.toUpperCase() == t && (i[i.length] = e[a].childNodes[r]) : e[a].childNodes[r].tagName == t && (i[i.length] = e[a].childNodes[r]); return i }, "undefined" == typeof window.dhtmlxEvent && (window.dhtmlxEvent = function(e, t, i) {
        e.addEventListener ? e.addEventListener(t, i, !1) : e.attachEvent && e.attachEvent("on" + t, i);
    }), dtmlXMLLoaderObject.prototype.xslDoc = null, dtmlXMLLoaderObject.prototype.setXSLParamValue = function(e, t, i) { i || (i = this.xslDoc), i.responseXML && (i = i.responseXML); var a = this.doXPath("/xsl:stylesheet/xsl:variable[@name='" + e + "']", i, "http://www.w3.org/1999/XSL/Transform", "single");
    ...
    function() {
        function e(e) { var t = !1,
                i = !1; if (window.getComputedStyle) { var a = window.getComputedStyle(e, null);
                t = a.display, i = a.visibility } else e.currentStyle && (t = e.currentStyle.display, i = e.currentStyle.visibility); var r = !1,
                s = scheduler._locate_css({ target: e }, "dhx_form_repeat", !1); return s && (r = !("0px" != s.style.height)), r = r || !e.offsetHeight, "none" != t && "hidden" != i && !r }
    ...
    function() {
        function e(e, t) { setTimeout(function() { if (e.box) { var a = e.callback;
        ...
        function s(t, i, r) {
            ...
            if (t.width && (s.style.width = t.width), t.height && (s.style.height = t.height), t.title && (d += '<div class="dhtmlx_popup_title" id="' + n + '">' + t.title + "</div>", l = !0), d += '<div class="dhtmlx_popup_text" ' + (l ? "" : ' id="' + n + '" ') + "><span>" + (t.content ? "" : t.text) + '</span></div><div  class="dhtmlx_popup_controls">',
                i) { var o = t.ok || scheduler.locale.labels.message_ok;
                void 0 === o && (o = "OK"), d += a(o, !0, "ok") }
            if (r) { var h = t.cancel || scheduler.locale.labels.message_cancel;
                void 0 === h && (h = "Cancel"), d += a(h, !1, "cancel") }
            if (t.buttons)
                for (var _ = 0; _ < t.buttons.length; _++) d += a(t.buttons[_], _);
            if (d += "</div>", s.innerHTML = d, t.content) { var u = t.content; "string" == typeof u && (u = document.getElementById(u)), "none" == u.style.display && (u.style.display = ""), s.childNodes[t.title ? 1 : 0].appendChild(u) }
            return s.onclick = function(i) {
                i = i || event;
                var a = i.target || i.srcElement,
                    r = scheduler._getClassName(a);
                if (r || (a = a.parentNode), r = scheduler._getClassName(a), "dhtmlx_popup_button" == r.split(" ")[0]) { var s = a.getAttribute("result");
        ...
        function l(e) { return n(e, !0, !0) }

        function o(e) { return n(e) }

        function h(e, t, i) { return "object" != typeof e && ("function" == typeof t && (i = t, t = ""), e = { text: e, type: t, callback: i }), e }

        function _(e, t, i, a) { return "object" != typeof e && (e = { text: e, type: t, expire: i, id: a }), e.id = e.id || u.uid(), e.expire = e.expire || u.expire, e }
        var c = null;
        document.attachEvent ? document.attachEvent("onkeydown", t) : document.addEventListener("keydown", t, !0),
            dhtmlx.alert = function() { var e = h.apply(this, arguments); return e.type = e.type || "confirm", d(e) }, dhtmlx.confirm = function() { var e = h.apply(this, arguments); return e.type = e.type || "alert", l(e) }, dhtmlx.modalbox = function() { var e = h.apply(this, arguments); return e.type = e.type || "alert", o(e) }, dhtmlx.modalbox.hide = function(e) { for (; e && e.getAttribute && !e.getAttribute("dhxbox");) e = e.parentNode;
        ...
        var u = dhtmlx.message = function(e, t, i, a) { e = _.apply(this, arguments), e.type = e.type || "info"; var s = e.type.split("-")[0]; switch (s) {
                case "alert":
                    return d(e);
                case "confirm":
                    return l(e);
        ...
        serialize_one: function(e, t) { if ("string" == typeof e) return e; var i = []; for (var a in e)
                if (e.hasOwnProperty(a)) { if (("id" == a || a == this.action_param) && "REST" == this._tMode) continue;
        ...
        _sendData: function(e, t) {
            if (e) {
                ...
                var i = new dtmlXMLLoaderObject(function(i, a, r, s, n) { var d = []; if (t) d.push(t);
                        else if (e)
                            for (var l in e) d.push(l); return i.afterUpdate(i, n, d) }, this, !0),
        ...
        afterUpdateCallback: function(e, t, i, a) {
            ...
            switch (i) {
                case "inserted":
                case "insert":
                    t != e && (this.obj[this._methods[2]](e, t), e = t); break;
                case "delete":
                case "deleted":
        ...
        afterUpdate: function(e, t, i) {
            if (window.JSON) try { var a = JSON.parse(t.xmlDoc.responseText),
                    r = a.action || this.getState(i) || "updated",
                    s = a.sid || i[0],
                    n = a.tid || i[0]; return e.afterUpdateCallback(s, n, r, a), void e.finalizeUpdate() } catch (d) {}
        ...
        afterAutoUpdate: function(e, t, i, a) { return "collision" == t ? (this._need_update = !0, !1) : !0 },
            ...
            i = i.replace("editing=true&", ""), this.getUpdates(i, function() {
                ...
                if (a.length) {
                    ...
                    for (var r = 0; r < a.length; r++) {
                        ...
                        switch (s) {
                            case "inserted":
                                e.callEvent("insertCallback", [a[r], n, d]); break;
                            case "updated":
                                e.callEvent("updateCallback", [a[r], n, d]); break;
                            case "deleted":
    ...
    }), dhtmlxError.catchError("LoadXML", function(e, t, i) { var a = i[0].responseText; switch (scheduler.config.ajax_error) {
            case "alert":
                window.alert(a); break;
            case "console":
                window.console.log(a) } }),
    function() {
        function e(e) { return (e + "").replace(a, " ").replace(r, " ") }
        ...
        scheduler._waiAria = {
            getAttributeString: function(i) {
                var a = [" "];
                for (var r in i)
                    if ("function" != typeof i[r] && "object" != typeof i[r]) { var s = t(e(i[r]));
                        a.push(r + "='" + s + "'") }
                return a.push(" "), a.join(" ")
            },
            setAttributes: function(t, i) { for (var a in i) t.setAttribute(a, e(i[a])); return t },
            ...
            eventBarAttrString: function(e) { return this.getAttributeString(this._getAttributes(this.setEventBarAttr, e)) },
            ...
            agendaDetailsBtnString: function() { return this.getAttributeString({ role: "button", "aria-label": scheduler.locale.labels.icon_details }) },
            ...
            minicalDayCell: function(e, t) { var i = t.valueOf() < scheduler._max_date.valueOf() && t.valueOf() >= scheduler._min_date.valueOf();
            ...
            lightboxSectionButtonAttrString: function(e) { return this.getAttributeString({ role: "button", "aria-label": e, tabindex: "0" }) },
            ...
            lightboxButtonAttrString: function(e) { return this.getAttributeString({ role: "button", "aria-label": scheduler.locale.labels[e], tabindex: "0" }) },
            ...
            lightboxSelectAttrString: function(e) { var t = ""; switch (e) {
                    case "%Y":
                        t = scheduler.locale.labels.year; break;
                    case "%m":
                        t = scheduler.locale.labels.month; break;
                    case "%d":
                        t = scheduler.locale.labels.day; break;
                    case "%H:%i":
                        t = scheduler.locale.labels.hour + " " + scheduler.locale.labels.minute } return scheduler._waiAria.getAttributeString({ "aria-label": t }) },
        ...
        e.style.width = Math.max(0, t) + "px", e.style.height = Math.max(0, i) + "px", arguments.length > 3 && (e.style.left = a + "px",
            e.style.top = r + "px")
    }, scheduler.get_elements = function() { for (var e = this._obj.getElementsByTagName("DIV"), t = 0; t < e.length; t++) { var i = scheduler._getClassName(e[t]),
                a = e[t].getAttribute("name") || "";
            i && (i = i.split(" ")[0]), this._els[i] || (this._els[i] = []), this._els[i].push(e[t]); var r = scheduler.locale.labels[a || i]; "string" != typeof r && a && !e[t].innerHTML && (r = a.split("_")[0]), r && (this._waiAria.labelAttr(e[t], r), e[t].innerHTML = r) } }, scheduler.unset_actions = function() {
        ...
        this._obj.onselectstart = function(e) { return !1 }, this._obj.onmousemove = function(e) { scheduler._temp_touch_block || scheduler._on_mouse_move(e || event) }, this._obj.onmousedown = function(e) {
            scheduler._ignore_next_click || scheduler._on_mouse_down(e || event);
        }, this._obj.onmouseup = function(e) { scheduler._ignore_next_click || scheduler._on_mouse_up(e || event) }, this._obj.ondblclick = function(e) { scheduler._on_dbl_click(e || event) }, this._obj.oncontextmenu = function(e) { var t = e || event,
                i = t.target || t.srcElement,
                a = scheduler.callEvent("onContextMenu", [scheduler._locate_event(i), t]); return a }
        ...
        if (!e || e == this._select_id) { var t = this._select_id;
        ...
        dhx_cal_data: function(e) {
            ...
            if (i && scheduler.config.select) { scheduler.select(i); var a = scheduler._getClassName(t); - 1 != a.indexOf("_icon") && scheduler._click.buttons[a.split(" ")[1].replace("icon_", "")](i) } else scheduler._close_not_saved(), (new Date).valueOf() - (scheduler._new_event || 0) > 500 && scheduler.unselect();
        },
        ...
        buttons: { "delete": function(e) { var t = scheduler.locale.labels.confirm_deleting;
    ...
    }, scheduler._get_column_index = function(e) { var t = 0; if (this._cols) { for (var i = 0, a = 0; i + this._cols[a] < e && a < this._cols.length;) i += this._cols[a], a++; if (t = a + (this._cols[t] ? (e - i) / this._cols[t] : 0), this._ignores && t >= this._cols.length)
    ...
    }, scheduler._close_not_saved = function() { if ((new Date).valueOf() - (scheduler._new_event || 0) > 500 && scheduler._edit_id) { var e = scheduler.locale.labels.confirm_closing;
        ...
        function i(e, t, i) { return !!(Math.abs(e - t) > i) } if (!e || !this._drag_pos) return !0; var a = 100,
            r = 5; return !!(this._drag_pos.has_moved || !this._drag_pos.timestamp || t.timestamp - this._drag_pos.timestamp > a || i(e.ev.clientX, t.ev.clientX, r) || i(e.ev.clientY, t.ev.clientY, r)) }, scheduler._correct_drag_start_date = function(e) {
        var t;
    ...
    }, scheduler._correct_drag_end_date = function(e, t) { var i;
        scheduler.matrix && (i = scheduler.matrix[scheduler._mode]), i = i || { x_step: 1, x_unit: "day" }; var a = 1 * e + scheduler._get_fictional_event_length(e, t, i); return new Date(1 * a - (scheduler._get_fictional_event_length(a, -1, i, -1) + 1)) }, scheduler._on_mouse_move = function(e) {
        if (this._drag_mode) {
            ...
            if (this._is_pos_changed(this._drag_pos, t)) {
                ...
                if (this._drag_pos = t, this._drag_pos.has_moved = !0, "create" == this._drag_mode) {
                    if (this._close_not_saved(), this.unselect(this._select_id), this._loading = !0, i = this._get_date_from_pos(t).valueOf(), !this._drag_start) { var r = this.callEvent("onBeforeEventCreated", [e, this._drag_id]); return r ? (this._loading = !1, void(this._drag_start = i)) : void(this._loading = !1) } a = i, a == this._drag_start;
                ...
                if (scheduler.matrix && (d = scheduler.matrix[scheduler._mode]), d = d || { x_step: 1, x_unit: "day" }, "move" == this._drag_mode) i = this._min_date.valueOf() + 6e4 * (t.y * this.config.time_step + 24 * t.x * 60 - (scheduler._move_pos_shift || 0)), !t.custom && this._table_view && (i += 1e3 * this.date.time_part(l.start_date)),
                    ...
                    } else { var _ = this.date.date_part(new Date(l.end_date.valueOf() - 1)).valueOf(),
                            c = new Date(_);
                ...
                if (this._table_view || g.getDate() == v.getDate() && g.getHours() < this.config.last_hour || scheduler._allow_dnd)
                    if (l.start_date = v, l.end_date = new Date(a), this.config.update_render) { var m = scheduler._els.dhx_cal_data[0].scrollTop;
        ...
        if (2 != e.button && !this.config.readonly && !this._drag_mode) {
            ...
            if (this._drag_mode) { var r = this._locate_event(t); if (this.config["drag_" + this._drag_mode] && this.callEvent("onBeforeDrag", [r, this._drag_mode, e])) { if (this._drag_id = r, (this._edit_id != this._drag_id || this._edit_id && "create" == this._drag_mode) && this._close_not_saved(), !this._drag_mode) return;
                    this._drag_event = scheduler._lame_clone(this.getEvent(this._drag_id) || {}), this._drag_pos = this._mouse_coords(e) } else this._drag_mode = this._drag_id = 0 } this._drag_start = null
        }
    }, scheduler._get_private_properties = function(e) {
        var t = {};
        for (var i in e) 0 === i.indexOf("_") && (t[i] = !0);
        return t
    }, scheduler._clear_temporary_properties = function(e, t) { var i = this._get_private_properties(e),
            a = this._get_private_properties(t); for (var r in a) i[r] || delete t[r] }, scheduler._on_mouse_up = function(e) {
            ...
            if (this._drag_mode && this._drag_id) {
                ...
                if (a && (this._drag_event._dhx_changed || !this._drag_event.start_date || r.start_date.valueOf() != this._drag_event.start_date.valueOf() || r.end_date.valueOf() != this._drag_event.end_date.valueOf())) {
                    ...
                    if (this.callEvent("onBeforeEventChanged", [r, e, s, this._drag_event]))
                        if (this._drag_id = this._drag_mode = null, s && this.config.edit_on_create) { if (this.unselect(), this._new_event = new Date, this._table_view || this.config.details_on_create || !this.config.select || !this.isOneDayEvent(this.getEvent(t))) return scheduler.callEvent("onDragEnd", [t, i, e]), this.showLightbox(t);
    ...
    }, scheduler._get_columns_num = function(e, t) { var i = 7; if (!scheduler._table_view) { var a = scheduler.date["get_" + scheduler._mode + "_end"];
            a && (t = a(e)), i = Math.round((t.valueOf() - e.valueOf()) / 864e5) } return i }, scheduler._get_timeunit_start = function() {
        return this.date[this._mode + "_start"](new Date(this._date.valueOf()))
    }, scheduler._get_view_end = function() { var e = this._get_timeunit_start(),
    ...
    }, scheduler._set_scale_col_size = function(e, t, i) { var a = this.config;
    ...
    }, scheduler._reset_ignores = function() { this._ignores = {}, this._ignores_detected = 0 }, scheduler._process_ignores = function(e, t, i, a, r) { this._reset_ignores(); var s = scheduler["ignore_" + this._mode]; if (s)
        ...
        function r(e) { var t = scheduler._colsS.height; return void 0 !== scheduler._colsS.heights[e + 1] && (t = scheduler._colsS.heights[e + 1] - (scheduler._colsS.heights[e] || 0)), t }
        ...
        for (var l = [], o = 0; 7 >= o; o++) { var h = (this._cols[o] || 0) - 1;
        ...
        for (var g = [], o = 0; a > o; o++) {
            ...
            for (var f = Math.max(r(o) - scheduler.xy.month_head_height, 0), m = 0; 7 > m; m++) {
                ...
                else { this._waiAria.monthCellAttr(p, i); var w = document.createElement("DIV");
                    w.className = y, w.innerHTML = this.templates.month_day(i), p.appendChild(w); var D = document.createElement("DIV");
                    D.className = x, D.style.height = f + "px", D.style.width = l[m], p.appendChild(D) } g.push(i);
                var E = i.getDate();
        ...
        for (var A = e.getElementsByTagName("div"), o = 0; o < g.length; o++) { var e = A[2 * o + 1],
                k = g[o];
            this._scales[+k] = e }
        for (var o = 0; o < g.length; o++) { var k = g[o];
    ...
    }, scheduler.getLabel = function(e, t) { for (var i = this.config.lightbox.sections, a = 0; a < i.length; a++)
            if (i[a].map_to == e)
                for (var r = i[a].options, s = 0; s < r.length; s++)
                    if (r[s].key == t) return r[s].label; return "" }, scheduler.updateCollection = function(e, t) {
    ...
    }, scheduler._get_real_event_length = function(e, t, i) { var a, r = t - e,
            s = i._start_correction + i._end_correction || 0,
            n = this["ignore_" + this._mode],
            d = 0;
        i.render ? (d = this._get_date_index(i, e), a = this._get_date_index(i, t)) : a = Math.round(r / 60 / 60 / 1e3 / 24); for (var l = !0; a > d;) { var o = scheduler.date.add(t, -i.x_step, i.x_unit);
            n && n(t) && (!l || l && n(o)) ? r -= t - o : (l = !1, r -= s), t = o, a-- } return r }, scheduler._get_fictional_event_length = function(e, t, i, a) {
        var r = new Date(e),
            s = a ? -1 : 1;
        ...
        var o, h = new Date(1 * e + t * s),
            ...
            c = 0;
        for (i.render ? (c = this._get_date_index(i, r), o = this._get_date_index(i, h)) : o = Math.round(t / 60 / 60 / 1e3 / 24); o * s >= c * s;) { var u = scheduler.date.add(r, i.x_step * s, i.x_unit);
        ...
        _add_days: function(e, t) { var i = new Date(e.valueOf()); if (i.setDate(i.getDate() + t), t == Math.round(t) && t > 0) { var a = +i - +e,
                    r = a % 864e5; if (r && e.getTimezoneOffset() == i.getTimezoneOffset()) { var s = r / 36e5;
                    i.setTime(i.getTime() + 60 * (24 - s) * 60 * 1e3) } } return t >= 0 && !e.getHours() && i.getHours() && (i.getDate() < e.getDate() || i.getMonth() < e.getMonth() || i.getFullYear() < e.getFullYear()) && i.setTime(i.getTime() + 36e5 * (24 - i.getHours())), i },
        add: function(e, t, i) {
        ...
        getISOWeek: function(e) { if (!e) return !1;
            ...
            i.setDate(e.getDate() + (4 - t)); var a = i.getFullYear(),
                r = Math.round((i.getTime() - new Date(a, 0, 1).getTime()) / 864e5),
                s = 1 + Math.floor(r / 7); return s },
        ...
        date: { month_full: ["Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosts", "Septiembre", "Octubre", "Noviembre", "Diciembre"], month_short: ["Ene", "Feb", "Mar", "Abr", "May", "Jun", "Jul", "Ago", "Sep", "Oct", "Nov", "Dic"], day_full: ["Domingo", "Lunes", "Martes", "Miercoles", "Jueves", "Viernes", "Sabado"], day_short: ["Dom", "Lun", "Mar", "Mie", "Jue", "Vie", "Sab"] },
        labels: {
            ...
            confirm_closing: "",
            confirm_deleting: "El evento se eliminará permanentemente, estás seguro?",
            section_description: "Descripción",
            section_time: "Periodo de tiempo",
            full_day: "Todo el día",
            confirm_recurring: "¿Quieres editar todo el conjunto de eventos repetidos?",
            section_recurring: "Repetir evento",
            button_recurring: "Disabled",
            button_recurring_open: "Enabled",
            button_edit_series: "Editar series",
            button_edit_occurrence: "Editar ocurrencia",
            agenda_tab: "Agenda",
            date: "Fecha",
        ...
        var t = scheduler.date.date_to_str,
            i = scheduler.config,
            a = function(e, t) { for (var i in t) e[i] || (e[i] = t[i]) };
    ...
    function() {
        ...
        if (this.config.multi_day && !this._table_view) { for (var s = [], n = [], a = 0; a < e.length; a++) this._is_main_area_event(e[a]) ? s.push(e[a]) : n.push(e[a]);
    ...
    scheduler.render_data = function(e, t) { e = this._pre_render_events(e, t); for (var i = 0; i < e.length; i++)
            if (this._table_view)
                if ("month" != scheduler._mode) this.render_event_bar(e[i]);
                else { var a = scheduler.config.max_month_events;
                    a !== 1 * a || e[i]._sorder < a ? this.render_event_bar(e[i]) : void 0 !== a && e[i]._sorder == a && scheduler._render_month_link(e[i]) } else this.render_event(e[i]) }, scheduler._get_first_visible_cell = function(e) {
        ...
        for (var r = 0; r < e.length; r++) {
            ...
            if (s._sday = this._get_event_sday(s), this._ignores[s._sday]) e.splice(r, 1), r--;
                ...
                if (i[s._sday] || (i[s._sday] = []), !t) {
                    ...
                    for (var u = h.length, g = !1, v = 0; v < h.length; v++) { var _ = h[v],
                            c = this._get_event_mapped_end_date(_); if (c.valueOf() <= s.start_date.valueOf()) { g = !0, s._sorder = _._sorder, u = v, s._inner = !0; break } }
                    if (h.length && (h[h.length - 1]._inner = !0), !g)
                        if (h.length)
                            if (h.length <= h[h.length - 1]._sorder) {
                                if (h[h.length - 1]._sorder)
                                    for (v = 0; v < h.length; v++) { for (var f = !1, m = 0; m < h.length; m++)
                                            if (h[m]._sorder == v) { f = !0; break }
                                        if (!f) { s._sorder = v; break } } else s._sorder = 0;
                                s._inner = !0;
                            } else { var p = h[0]._sorder; for (v = 1; v < h.length; v++) h[v]._sorder > p && (p = h[v]._sorder);
        ...
        if (!t) { for (var r = 0; r < e.length; r++) e[r]._count = i[e[r]._sday].max_count; for (var r = 0; r < a.length; r++) a[r]._count = i[a[r]._sday].max_count }
        return e
    ...
    }, scheduler._copy_event = function(e) { return this._copy_dummy.prototype = e, new this._copy_dummy }, scheduler._rendered = [], scheduler.clear_view = function() { for (var e = 0; e < this._rendered.length; e++) { var t = this._rendered[e];
            t.parentNode && t.parentNode.removeChild(t) } this._rendered = [] }, scheduler.updateEvent = function(e) {
    ...
    }, scheduler._get_dnd_order = function(e, t, i) { if (!this._drag_event) return e;
        this._drag_event._orig_sorder ? e = this._drag_event._orig_sorder : this._drag_event._orig_sorder = e; for (var a = t * e; a + t > i;) e--, a -= t; return e = Math.max(e, 0) }, scheduler._get_event_bar_pos = function(e) {
        ...
        for (var a = e.target || e.srcElement, r = ""; a;) {
            if (r = scheduler._getClassName(a)) { var s = r.indexOf(t); if (s >= 0) { if (!i) return a; var n = 0 === s || !scheduler._trim(r.charAt(s - 1)),
                        d = s + t.length >= r.length || !scheduler._trim(r.charAt(s + t.length)); if (n && d) return a } } a = a.parentNode
        }
        return null
    ...
    }, scheduler._edit_stop_event = function(e, t) { this._new_event ? (t ? this.callEvent("onEventAdded", [e.id, e]) : e && this.deleteEvent(e.id, !0), this._new_event = null) : t && this.callEvent("onEventChanged", [e.id, e]) }, scheduler.getEvents = function(e, t) { var i = []; for (var a in this._events) { var r = this._events[a];
            r && (!e && !t || r.start_date < t && r.end_date > e) && i.push(r) } return i }, scheduler.getRenderedEvent = function(e) {
        if (e) {
        ...
        if (t = t || scheduler._mode, i && (!this.checkEvent("onBeforeEventDisplay") || this.callEvent("onBeforeEventDisplay", [i, t]))) {
            ...
            if (scheduler.config.highlight_displayed_event && (i.color = scheduler.config.displayed_event_color,
                    i.textColor = scheduler.config.displayed_event_text_color), scheduler.setCurrentView(new Date(i.start_date), t), i.color = s, i.textColor = n, scheduler.config.scroll_hour = a, scheduler.config.preserve_scroll = r, scheduler.matrix && scheduler.matrix[t]) { var d = scheduler.getRenderedEvent(i.id);
                d && (scheduler._els.dhx_cal_data[0].scrollTop = getAbsoluteTop(d) - getAbsoluteTop(scheduler._els.dhx_cal_data[0]) - 20) } scheduler.callEvent("onAfterEventDisplay", [i, t])
        }
    ...
    }, scheduler.on_load = function(e) { var t, i = !1; if (this._process && "xml" != this._process) try { t = this[this._process].parse(e.xmlDoc.responseText) } catch (a) { i = !0 } else t = this._magic_parser(e), t || (i = !0);
        ...
        var t;
        if (!e.getXMLTopNode) { var i = e.xmlDoc.responseText;
        ...
        for (var r = e.doXPath("//coll_options"), s = 0; s < r.length; s++) { var n = r[s].getAttribute("for"),
                d = this.serverList[n]; if (d) { d.splice(0, d.length); for (var l = e.doXPath(".//item", r[s]), o = 0; o < l.length; o++) { for (var h = l[o], _ = h.attributes, c = { key: l[o].getAttribute("value"), label: l[o].getAttribute("label") }, u = 0; u < _.length; u++) { var g = _[u]; "value" != g.nodeName && "label" != g.nodeName && (c[g.nodeName] = g.nodeValue) } d.push(c) } } } r.length && scheduler.callEvent("onOptionsLoad", []);
        for (var v = e.doXPath("//userdata"), s = 0; s < v.length; s++) { var f = this._xmlNodeToJSON(v[s]);
            this._userdata[f.name] = f.text }
        var m = [];
        t = e.doXPath("//event");
        for (var s = 0; s < t.length; s++) { var p = m[s] = this._xmlNodeToJSON(t[s]);
    ...
    scheduler.ical = {
        parse: function(e) { var t = e.match(RegExp(this.c_start + "[^\f]*" + this.c_end, "")); if (t.length) { t[0] = t[0].replace(/[\r\n]+(?=[a-z \t])/g, " "), t[0] = t[0].replace(/\;[^:\r\n]*:/g, ":"); for (var i, a = [], r = RegExp("(?:" + this.e_start + ")([^\f]*?)(?:" + this.e_end + ")", "g"); null !== (i = r.exec(t));) { for (var s, n = {}, d = /[^\r\n]+[\r\n]+/g; null !== (s = d.exec(i[1]));) this.parse_param(s.toString(), n);
                    n.uid && !n.id && (n.id = n.uid), a.push(n) } return a } },
        ...
        parse_date: function(e, t, i) { var a = e.split("T");
            a[1] && (t = a[1].substr(0, 2), i = a[1].substr(2, 2)); var r = a[0].substr(0, 4),
                s = parseInt(a[0].substr(4, 2), 10) - 1,
                n = a[0].substr(6, 2); return scheduler.config.server_utc && !a[1] ? new Date(Date.UTC(r, s, n, t, i)) : new Date(r, s, n, t, i) },
    ...
    scheduler.formSection = function(e) { var t = this.config.lightbox.sections,
            i = 0; for (i; i < t.length && t[i].name != e; i++); var a = t[i];
        scheduler._lightbox || scheduler.getLightbox(); var r = document.getElementById(a.id),
            s = r.nextSibling,
            n = { section: a, header: r, node: s, getValue: function(e) { return scheduler.form_blocks[a.type].get_value(s, e || {}, a) }, setValue: function(e, t) { return scheduler.form_blocks[a.type].set_value(s, e, t || {}, a) } },
            d = scheduler._lightbox_controls["get_" + a.type + "_control"]; return d ? d(n) : n }, scheduler._lightbox_controls.get_template_control = function(e) {
        ...
        select: {
            render: function(e) { for (var t = (e.height || "23") + "px", i = "<div class='dhx_cal_ltext' style='height:" + t + ";'><select style='width:100%;'>", a = 0; a < e.options.length; a++) i += "<option value='" + e.options[a].key + "'>" + e.options[a].label + "</option>"; return i += "</select></div>" },
        ...
        time: {
            render: function(e) {
                ...
                for (var n = "", d = 0; d < t.length; d++) {
                    ...
                    if (o) { var v = scheduler._waiAria.lightboxSelectAttrString(l),
            ...
            get_value: function(e, t, i) {
                ...
                if (t.start_date = new Date(a[r[3]].value, a[r[2]].value, a[r[1]].value, 0, a[r[0]].value),
                    t.end_date = new Date(a[r[3] + 4].value, a[r[2] + 4].value, a[r[1] + 4].value, 0, a[r[0] + 4].value), !a[r[3]].value || !a[r[3] + 4].value) { var s = this.getEvent(this._lightbox_id);
        ...
        } else { var n = this.templates.event_header(i.start_date, i.end_date, i),
                d = (this.templates.event_bar_text(i.start_date, i.end_date, i) || "").substr(0, 70);
            r.push(n), r.push(d), a[1].innerHTML = n, a[2].innerHTML = d } this._waiAria.lightboxHeader(t, r.join(" "));
    ...
    }, scheduler._lightbox_out = function(e) { for (var t = this.config.lightbox.sections, i = 0; i < t.length; i++) { var a = document.getElementById(t[i].id);
            a = a ? a.nextSibling : a; var r = this.form_blocks[t[i].type],
                s = r.get_value.call(this, a, e, t[i]); "auto" != t[i].map_to && (e[t[i].map_to] = s) } return e }, scheduler._empty_lightbox = function(e) {
        ...
        this.getLightbox().onclick = function(e) {
            ...
            if (t && i) switch (i) {
                ...
                a = i.querySelector("[dhx_button]"); switch (a || (a = i.parentNode.querySelector(".dhx_custom_button, .dhx_readonly")), (e || t).keyCode) {
                case 32:
                    if ((e || t).shiftKey) return;
                    a && a.click && a.click(); break;
                case scheduler.keys.edit_save:
                    if ((e || t).shiftKey) return;
                    a && a.click ? a.click() : scheduler.save_lightbox(); break;
        ...
        if (!this._lightbox) {
            ...
            for (var r = 0; r < s.length; r++) { var c = s[r]; if (c.id && document.getElementById(c.id)) { var u = document.getElementById(c.id),
                        g = u.querySelector("label"),
                        v = u.nextSibling; if (v) { var f = v.querySelector("input, select, textarea");
                        f && (c.inputId = f.id || "input_" + scheduler.uid(), f.id || (f.id = c.inputId), g.setAttribute("for", c.inputId)) } } } this.setLightboxSize(), this._init_lightbox_events(this), e.style.display = "none", e.style.visibility = "visible"
        }
        ...
        function a(e, t, i) { dhtmlxEvent(e, t, function(e) { return scheduler._is_lightbox_open() ? !0 : i(e) }) }
        ...
        function s(e) {
            ...
            "create" == t && i && (scheduler.render_view_data = function() { for (var e = scheduler.getState().drag_id, t = scheduler.getEvent(e), a = i.y_property, r = scheduler.getEvents(t.start_date, t.end_date), s = 0; s < r.length; s++) r[s][a] != t[a] && (r.splice(s, 1), s--);
        ...
        if (t) {
            var i = "";
            if (scheduler._drag_id && !e) { var a = scheduler.getEvent(scheduler._drag_id);
    ...
    }, scheduler._validId = function(e) { return !0 }, scheduler.setUserData = function(e, t, i) { if (e) { var a = this.getEvent(e);
        ...
        if (!scheduler.skin || "classic" !== scheduler.skin && "glossy" !== scheduler.skin || (a = 1), this._configure(scheduler.config, scheduler._skin_settings, a), this._configure(scheduler.xy, scheduler._skin_xy, a), "flat" === scheduler.skin && (scheduler.xy.scale_height = 35, scheduler.templates.hour_scale = function(e) {
            ...
            r && (r.padding = 14), scheduler.templates.event_bar_date = function(e, t, i) { return "• <b>" + scheduler.templates.event_date(e) + "</b> " }, scheduler.attachEvent("onTemplatesReady", function() {
